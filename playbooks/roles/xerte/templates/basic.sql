...
DROP TABLE IF EXISTS `{{xerte__db_prefix}}additional_sharing`;
DROP TABLE IF EXISTS `{{xerte__db_prefix}}folderdetails`;
DROP TABLE IF EXISTS `{{xerte__db_prefix}}ldap`;
DROP TABLE IF EXISTS `{{xerte__db_prefix}}logindetails` ;
DROP TABLE IF EXISTS `{{xerte__db_prefix}}originaltemplatesdetails` ;
DROP TABLE IF EXISTS `{{xerte__db_prefix}}play_security_details` ;
DROP TABLE IF EXISTS `{{xerte__db_prefix}}sitedetails` ;
DROP TABLE IF EXISTS `{{xerte__db_prefix}}syndicationcategories` ;
DROP TABLE IF EXISTS `{{xerte__db_prefix}}syndicationlicenses` ;
DROP TABLE IF EXISTS `{{xerte__db_prefix}}templatedetails` ;
DROP TABLE IF EXISTS `{{xerte__db_prefix}}templaterights` ;
DROP TABLE IF EXISTS `{{xerte__db_prefix}}templatesyndication` ;
DROP TABLE IF EXISTS `{{xerte__db_prefix}}user_sessions` ;
DROP TABLE IF EXISTS `{{xerte__db_prefix}}user` ;

DROP TABLE IF EXISTS `{{xerte__db_prefix}}lti_context` ;
DROP TABLE IF EXISTS `{{xerte__db_prefix}}lti_keys` ;
DROP TABLE IF EXISTS `{{xerte__db_prefix}}lti_resource` ;
DROP TABLE IF EXISTS `{{xerte__db_prefix}}lti_user` ;


CREATE TABLE `{{xerte__db_prefix}}additional_sharing` (
...
CREATE TABLE `{{xerte__db_prefix}}folderdetails` (
...
CREATE TABLE `{{xerte__db_prefix}}ldap` (
...
CREATE TABLE `{{xerte__db_prefix}}logindetails` (
...
CREATE TABLE `{{xerte__db_prefix}}originaltemplatesdetails` (
...
CREATE TABLE `{{xerte__db_prefix}}sitedetails` (
...
CREATE TABLE `{{xerte__db_prefix}}templaterights` (
  `template_id` bigint(20) NOT NULL,
...
CREATE TABLE `{{xerte__db_prefix}}templatesyndication` (
  `template_id` bigint(20) NOT NULL,
  `description` char(255) DEFAULT NULL,
...
CREATE TABLE `{{xerte__db_prefix}}user_sessions` (
...
CREATE TABLE `{{xerte__db_prefix}}user` (
...
CREATE TABLE IF NOT EXISTS `{{xerte__db_prefix}}lti_context` (
...
CREATE TABLE IF NOT EXISTS `{{xerte__db_prefix}}lti_keys` (
...
CREATE TABLE IF NOT EXISTS `{{xerte__db_prefix}}lti_resource` (
...
CREATE TABLE IF NOT EXISTS `{{xerte__db_prefix}}lti_user` (
