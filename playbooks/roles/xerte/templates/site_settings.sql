...
{% for field in [
    ...
    {'name':'news_text','value':xerte__news_text|b64encode()},
    {'name':'pod_one','value':xerte__pod_one|b64encode()},
    {'name':'pod_two','value':xerte__pod_two|b64encode()},
    ...
    {'name':'form_string','value':xerte__form_string|b64encode()},
    {'name':'peer_form_string','value':xerte__peer_form_string|b64encode()},
    ...
    {'name':'play_edit_preview_query','value':xerte__play_edit_preview_query|b64encode()},
